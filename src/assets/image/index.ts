...
export { ReactComponent as ImgExplanation3 } from './img_explanation_3.svg';
export { ReactComponent as ImgExplanation4 } from './img_explanation_4.svg';
export { ReactComponent as ImgExplanation5 } from './img_explanation_5.svg';
